          ...
          <div className="lg:col-span-2">
            ...
            >
              <Link to="/" className="inline-block mb-4">
                <img 
                  src="/creative-approach-white.png" 
              ...
              <p className="text-gray-400 mb-6">
                ...
                Based in Takoradi, delivering excellence across Ghana.
              </p>
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 transition-all"
                  >
